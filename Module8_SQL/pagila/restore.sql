...
CREATE DATABASE pagila WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'C' LC_CTYPE = 'C';
...
\.
COPY public.actor (actor_id, first_name, last_name, last_update) FROM '$$PATH$$/3448.dat';
...
\.
COPY public.address (address_id, address, address2, district, city_id, postal_code, phone, last_update) FROM '$$PATH$$/3456.dat';
...
\.
COPY public.category (category_id, name, last_update) FROM '$$PATH$$/3450.dat';
...
\.
COPY public.city (city_id, city, country_id, last_update) FROM '$$PATH$$/3458.dat';
...
\.
COPY public.country (country_id, country, last_update) FROM '$$PATH$$/3460.dat';
...
\.
COPY public.customer (customer_id, store_id, first_name, last_name, email, address_id, activebool, create_date, last_update, active) FROM '$$PATH$$/3462.dat';
...
\.
COPY public.film (film_id, title, description, release_year, language_id, original_language_id, rental_duration, rental_rate, length, replacement_cost, rating, last_update, special_features, fulltext) FROM '$$PATH$$/3452.dat';
...
\.
COPY public.film_actor (actor_id, film_id, last_update) FROM '$$PATH$$/3453.dat';
...
\.
COPY public.film_category (film_id, category_id, last_update) FROM '$$PATH$$/3454.dat';
...
\.
COPY public.inventory (inventory_id, film_id, store_id, last_update) FROM '$$PATH$$/3464.dat';
...
\.
COPY public.language (language_id, name, last_update) FROM '$$PATH$$/3466.dat';
...
\.
COPY public.payment (payment_id, customer_id, staff_id, rental_id, amount, payment_date) FROM '$$PATH$$/3468.dat';
...
\.
COPY public.payment_p2007_01 (payment_id, customer_id, staff_id, rental_id, amount, payment_date) FROM '$$PATH$$/3469.dat';
...
\.
COPY public.payment_p2007_02 (payment_id, customer_id, staff_id, rental_id, amount, payment_date) FROM '$$PATH$$/3470.dat';
...
\.
COPY public.payment_p2007_03 (payment_id, customer_id, staff_id, rental_id, amount, payment_date) FROM '$$PATH$$/3471.dat';
...
\.
COPY public.payment_p2007_04 (payment_id, customer_id, staff_id, rental_id, amount, payment_date) FROM '$$PATH$$/3472.dat';
...
\.
COPY public.payment_p2007_05 (payment_id, customer_id, staff_id, rental_id, amount, payment_date) FROM '$$PATH$$/3473.dat';
...
\.
COPY public.payment_p2007_06 (payment_id, customer_id, staff_id, rental_id, amount, payment_date) FROM '$$PATH$$/3474.dat';
...
\.
COPY public.rental (rental_id, rental_date, inventory_id, customer_id, return_date, staff_id, last_update) FROM '$$PATH$$/3476.dat';
...
\.
COPY public.staff (staff_id, first_name, last_name, address_id, email, store_id, active, username, password, last_update, picture) FROM '$$PATH$$/3478.dat';
...
\.
COPY public.store (store_id, manager_staff_id, address_id, last_update) FROM '$$PATH$$/3480.dat';
