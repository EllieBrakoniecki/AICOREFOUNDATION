...
class Scrape_Celebrity_IMDB:
    def __init__(self, url):
        ...
        self.driver = webdriver.Remote( 'http://127.0.0.1:4444/wd/hub', DesiredCapabilities.CHROME, options=self.chrome_options)
        self.driver.get(url)  
        print("Test")      
        self.celebrity_name = self.driver.find_element(By.XPATH, "//span[@class='itemprop']").text   
...
if __name__ == '__main__':
    ...
    print(Samueldf)
    Samueldf.to_csv('imdb_scraper.csv',mode='a',index=False, header=True)
